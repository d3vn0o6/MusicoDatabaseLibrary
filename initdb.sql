-- TABLE USERS--
CREATE TABLE IF NOT EXISTS IF NOT EXISTS mskt_users (
...
-- TABLE STYLES --
CREATE TABLE IF NOT EXISTS IF NOT EXISTS mskt_styles (
    id_style INTEGER PRIMARY KEY AUTOINCREMENT,
    style_name TEXT NOT NULL,
	style_description TEXT
);
-- TABLE ARTISTS --
CREATE TABLE IF NOT EXISTS IF NOT EXISTS mskt_artists (
...
-- TABLE ALBUMS --
CREATE TABLE IF NOT EXISTS IF NOT EXISTS mskt_albums (
...
-- TABLE SONGS --
CREATE TABLE IF NOT EXISTS IF NOT EXISTS mskt_songs (
...
-- FAVORITES --
CREATE TABLE IF NOT EXISTS mskt_favorites (
...
-- PLAYLISTS --
CREATE TABLE IF NOT EXISTS IF NOT EXISTS mskt_playlists (
...
-- PLAYLISTS_SONGS --
CREATE TABLE IF NOT EXISTS mskt_playlists_songs (
